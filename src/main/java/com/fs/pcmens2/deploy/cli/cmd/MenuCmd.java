...
public class MenuCmd implements Runnable {
    @Override public void run() {
        ...
        while (true) {
            System.out.println("\n=== pcm-deploy ===");
            System.out.println("1) Instalar (desde incoming)");
            System.out.println("2) Activar versión");
            ...
            switch (sc.nextLine().trim()) {
                case "1" -> System.out.println("Ejemplo: pcm-deploy install --from /opt/pcm-deploy/incoming/platform-2.4.0.zip");
                case "2" -> System.out.println("Ejemplo: pcm-deploy activate --version 2.4.0");
